 ...
 */
public class tapModule extends Activity implements View.OnTouchListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        exitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(tapModule.this, moduleStats.class);
                intent.putExtra("time", seconds);
                intent.putExtra("total", total);
                intent.putExtra("correct", correct);
                intent.putExtra("method", "Tapping");
    ...
    public static class CardBackFragment extends Fragment
    {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            failButton = (Button) backView.findViewById(R.id.failButton);
            rightButton = (Button) backView.findViewById(R.id.passButton);
